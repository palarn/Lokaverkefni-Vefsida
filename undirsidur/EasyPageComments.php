...
// ------------------------------------
  ...
  var $security_question = "Ef ég rita þrír, síðan sjö, hvaða tölu skrifaði ég?";
...
<?php } ?>
      ...
      <div class="EPC-form-comment">
        <label>Skrifaðu <span class="EPC-comment-type">komment eða spurningu</span>:</label>
      ...
      <div class="EPC-form-notify">
        <label>Hakaðu við ef þú villt fá e-mail þegar kommenti er svarað: </label>
